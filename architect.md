...
## Before You Start
Read `CLAUDE.md` in the project root for full project specifications. If no CLAUDE.md exists, ask for project context before making architectural decisions.
